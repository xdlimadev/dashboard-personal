...
async function moveTask(completeBtn, li) {
  completeBtn.addEventListener("click", async () => {
    ...
    const destinationList = document.getElementById(`${newState}-list`);
...
function setupDragAndDrop() {
  ...
  lists.forEach((list) => {
    if (list.hasAttribute("data-drag-listener")) return;
    list.setAttribute("data-drag-listener", "true");
